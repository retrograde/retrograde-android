...
object deps {
    ...
    object libs {
        const val ankoCoroutines                = "org.jetbrains.anko:anko-coroutines:0.10.3"
        const val archLifecycleCommonJava8      = "android.arch.lifecycle:common-java8:${versions.arch}"
        const val archPaging                    = "android.arch.paging:runtime:1.0.0-alpha4-1"
        ...
        const val googleApiServicesDrive        = "com.google.apis:google-api-services-drive:v3-rev92-1.23.0"
        const val jna                           = "net.java.dev.jna:jna:4.5.0@aar"
        ...
        const val kotlinxCoroutinesAndroid      = "org.jetbrains.kotlinx:kotlinx-coroutines-android:0.20"
        ...
        const val roomRuntime                   = "android.arch.persistence.room:runtime:${versions.arch}"
        const val roomRxJava2                   = "android.arch.persistence.room:rxjava2:${versions.arch}"
        const val rxAndroid2                    = "io.reactivex.rxjava2:rxandroid:2.0.1"
        const val rxJava2                       = "io.reactivex.rxjava2:rxjava:2.1.7"
        const val rxPermissions2                = "com.tbruyelle.rxpermissions2:rxpermissions:0.9.4@aar"
